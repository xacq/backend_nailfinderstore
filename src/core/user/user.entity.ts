...
export enum UserStatus { ACTIVE='active', INVITED='invited', SUSPENDED='suspended' }

@Entity('users')
@Index('ux_users_email', ['email'], { unique: true })
export class User extends SoftDeletableEntity {
  @ManyToOne(() => Business, b => b.defaultBusinessUsers, { nullable: true, onDelete: 'SET NULL' })
  @Index('fk_users_business')
