...
export class Technician extends TimestampedEntity {
  ...
  ratingAverage?: string | null; // :contentReference[oaicite:22]{index=22}
  @Column({ name: 'is_active', type: 'tinyint', default: () => '1' })
  isActive!: boolean; // :contentReference[oaicite:23]{index=23}
}
